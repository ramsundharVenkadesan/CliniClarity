...
from Agent.Prompts import Query_Prompt # Import prompt string passed to the model
...
mcp_server_parameters = StdioServerParameters(command="python", # Runtime environment of the MCP server
                                              args=["/Users/ram/Downloads/CliniGraph/MCP/PubMed.py"]) # Configuration to find and launch the local PubMed server
