...
def audit_loop(state:GraphState) -> Dict[str, Any]: # Node functon to audit the retrieved summary response
    print("🔄 INITIATING REFLECTION AUDIT LOOP")
    ...
    doc_hash = state.get("doc_hash") # Retrieve the document hash

    if doc_hash: # The document hash exists
        SUMMARY_CACHE[doc_hash] = final_llm_summary # Update the hash with final generated summary
